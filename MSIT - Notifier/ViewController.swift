...
//  MSIT - Notifier
//
//  Created by Abhishek Sansanwal on 09/11/20.
...
class ViewController: UIViewController, UITabBarDelegate, UITableViewDelegate, UITableViewDataSource, WKNavigationDelegate {
    
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var tabBar: UITabBar!
    
    let cellReuseIdentifier = "cell"
    var url = URL(string: "http://www.msit.in/notices")!
    ...
    func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
        switch item.tag {
        case 1:
            url = URL(string: "http://www.msit.in/notices")!
           run()
        case 2:
            url = URL(string: "http://www.msit.in/latest_news")!
            run()
        default:
            break
        }
